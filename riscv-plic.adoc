...
image::https://github.com/changab/riscv-plic-acpi-images/blob/Test-UNIX-PLC/Images/PLIC.jpg[GitHub][1000,643]
...
image::https://github.com/changab/riscv-plic-acpi-images/blob/Test-UNIX-PLC/Images/PLICArch.jpg[GitHub]
